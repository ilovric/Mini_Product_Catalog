create or replace package pkg_dozvole_zabrane as
 ...
 -- Dohvat direktno dozvoljenih i zabranjenih proizvoda za produkt

 function f_dohvati_pat_req_for (p_pat_id number, p_req_for char) return varchar2;
 -- Dohvat direktno dozvoljenih i zabranjenih proizvoda za produkt_atribut
...
########################################################################################### */
    ...
    exception
        ...
        when TOO_MANY_ROWS then
            return 'Vraćeno više redaka za produkt!';
  ...
  ########################################################################################### */    
    ...
    exception
        when no_data_found then
            ...
            return null;
        when too_many_rows then
            return 'Vraćeno više redaka za produkt_atribut!';
