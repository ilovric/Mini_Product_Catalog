...
BEGIN
    ...
    if v_produkt is null then
            ...
            dbms_output.put_line( 'Obavezni produkti: '  || pkg_dozvole_zabrane.f_dohvati_req_for ( v_produkt,'REQ'));  
            dbms_output.new_line;
            dbms_output.put_line( 'Zabranjeni produkti: ' || pkg_dozvole_zabrane.f_dohvati_req_for ( v_produkt,'FOR'));
    else
        ...
        if v_produkt_atribut != 0 then
            ...
            dbms_output.put_line( 'Obavezni produkti: '  || pkg_dozvole_zabrane.f_dohvati_req_for ( v_produkt_atribut,'REQ'));
            dbms_output.new_line;
            dbms_output.put_line( 'Zabranjeni produkti: ' || pkg_dozvole_zabrane.f_dohvati_req_for ( v_produkt_atribut,'FOR'));           
        else 
